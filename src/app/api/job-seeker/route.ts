import { AdditionalContactInfromation, Education, JobSeeker, KnowledgeOfLanguages, WorkExperience } from "@prisma/client";
...
async function postJobSeeker(req: NextRequest) {
  try {
    ...
    structuredLogger.error("api.job-seeker.post.internal_error", {
      tag: "INTERNAL",
