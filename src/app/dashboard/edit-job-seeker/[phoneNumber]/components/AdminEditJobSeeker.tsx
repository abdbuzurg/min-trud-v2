...
export default function AdminEditJobSeeker({ phoneNumber }: Props) {
  ...
  useEffect(() => {
    axios.get(`/api/dashboard/edit-job-seeker`, {
      ...
      const availableEducations = ["без образования", "неполное начальное (4 класса)", "неполное среднее (9 классов)", "полное среднее (11 классов)", "средняя специальность", "профессиональное техническое", "неполное высшее (бакалавриат)", "высшее", "аспирантура", "докторантура", "другое"]
            ...
            <span className="inline-flex items-center gap-2">
              ...
              <span className="relative inline-flex items-center group">
                <button
                  ...
                  aria-describedby="tin-tooltip-admin-edit-form"
                >
                  ?
                </button>
                <span
                  id="tin-tooltip-admin-edit-form"
                  role="tooltip"
          ...
          <span className="inline-flex items-center gap-2">
            ...
            <span className="relative inline-flex items-center group">
              <button
                ...
                aria-describedby="photo-tooltip-admin-edit-form"
              >
                ?
              </button>
              <span
                id="photo-tooltip-admin-edit-form"
                role="tooltip"
                className="pointer-events-none absolute left-1/2 top-full z-20 mt-2 w-80 -translate-x-1/2 rounded-lg border border-gray-200 bg-white p-2 text-xs font-normal text-gray-600 opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100 group-focus-within:opacity-100"
              >
